...
namespace InformeProyecto.Services.DataSet {
    ...
    public partial class ProyectoDataSet : global::System.Data.DataSet {
        ...
        public partial class detalleFacturaDataTable : global::System.Data.TypedTableBase<detalleFacturaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public detalleFacturaRow AdddetalleFacturaRow(int IdDetalles, FacturaRow parentFacturaRowByFK_detalleFactura_ToFactura, string Producto, string Descripcion, int Cantidad, double Precio) {
        ...
        public partial class InformeDataTable : global::System.Data.TypedTableBase<InformeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InformeRow AddInformeRow(int DNI, string Nombre, string Direccion, string Telefono, string Email, int IdDetalles, int idFactura, string Producto, string Descripcion, int Cantidad, double Precio, clienteRow parentclienteRowByFK_Factura_ToCliente1, string Fecha) {
                ...
                if ((parentclienteRowByFK_Factura_ToCliente1 != null)) {
                    columnValuesArray[12] = parentclienteRowByFK_Factura_ToCliente1[0];
                }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InformeRow FindByDNIIdDetallesIdentificador(int DNI, int IdDetalles, int Identificador) {
        ...
        public partial class detalleFacturaRow : global::System.Data.DataRow {
            ...
            public string Producto {
                get {
                    try {
                        return ((string)(this[this.tabledetalleFactura.ProductoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Producto\' de la tabla \'detalleFactura\' es DBNull.", e);
                    }
                }
                set {
        ...
        public partial class InformeRow : global::System.Data.DataRow {
            ...
            public string Producto {
                get {
                    try {
                        return ((string)(this[this.tableInforme.ProductoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Producto\' de la tabla \'Informe\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableInforme.ProductoColumn] = value;
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsProductoNull() {
                return this.IsNull(this.tableInforme.ProductoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetProductoNull() {
                this[this.tableInforme.ProductoColumn] = global::System.Convert.DBNull;
            }
...
SELECT DNI, Nombre, Direccion, Telefono, Email FROM cliente WHERE (DNI = @DNI)";
    ...
    public partial class FacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Factura] WHERE (([Identificador] = @Original_Identificador) AN" +
                "D ((@IsNull_idCliente = 1 AND [idCliente] IS NULL) OR ([idCliente] = @Original_i" +
                "dCliente)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_" +
                "Fecha)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Factura] ([idCliente], [Fecha]) VALUES (@idCliente, @Fecha);\r\n" +
                "SELECT Identificador, idCliente, Fecha FROM Factura WHERE (Identificador = SCOPE" +
                "_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Factura] SET [idCliente] = @idCliente, [Fecha] = @Fecha WHERE (([Identificador] = @Original_Identificador) AND ((@IsNull_idCliente = 1 AND [idCliente] IS NULL) OR ([idCliente] = @Original_idCliente)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)));
SELECT Identificador, idCliente, Fecha FROM Factura WHERE (Identificador = @Identificador)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Identificador, idCliente, Fecha FROM dbo.Factura";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class detalleFacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[detalleFactura] WHERE (([IdDetalles] = @Original_IdDetalles) AND ([idFactura] = @Original_idFactura) AND ((@IsNull_Producto = 1 AND [Producto] IS NULL) OR ([Producto] = @Original_Producto)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ((@IsNull_Cantidad = 1 AND [Cantidad] IS NULL) OR ([Cantidad] = @Original_Cantidad)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[detalleFactura] ([IdDetalles], [idFactura], [Producto], [Descripcion], [Cantidad], [Precio]) VALUES (@IdDetalles, @idFactura, @Producto, @Descripcion, @Cantidad, @Precio);
SELECT IdDetalles, idFactura, Producto, Descripcion, Cantidad, Precio FROM detalleFactura WHERE (IdDetalles = @IdDetalles)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[detalleFactura] SET [IdDetalles] = @IdDetalles, [idFactura] = @idFactura, [Producto] = @Producto, [Descripcion] = @Descripcion, [Cantidad] = @Cantidad, [Precio] = @Precio WHERE (([IdDetalles] = @Original_IdDetalles) AND ([idFactura] = @Original_idFactura) AND ((@IsNull_Producto = 1 AND [Producto] IS NULL) OR ([Producto] = @Original_Producto)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ((@IsNull_Cantidad = 1 AND [Cantidad] IS NULL) OR ([Cantidad] = @Original_Cantidad)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)));
SELECT IdDetalles, idFactura, Producto, Descripcion, Cantidad, Precio FROM detalleFactura WHERE (IdDetalles = @IdDetalles)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT IdDetalles, idFactura, Producto, Descripcion, Cantidad, Precio FROM dbo.de" +
                "talleFactura";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_IdDetalles, int Original_idFactura, string Original_Producto, string Original_Descripcion, global::System.Nullable<int> Original_Cantidad, global::System.Nullable<double> Original_Precio) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int IdDetalles, int idFactura, string Producto, string Descripcion, global::System.Nullable<int> Cantidad, global::System.Nullable<double> Precio) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int IdDetalles, int idFactura, string Producto, string Descripcion, global::System.Nullable<int> Cantidad, global::System.Nullable<double> Precio, int Original_IdDetalles, int Original_idFactura, string Original_Producto, string Original_Descripcion, global::System.Nullable<int> Original_Cantidad, global::System.Nullable<double> Original_Precio) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int idFactura, string Producto, string Descripcion, global::System.Nullable<int> Cantidad, global::System.Nullable<double> Precio, int Original_IdDetalles, int Original_idFactura, string Original_Producto, string Original_Descripcion, global::System.Nullable<int> Original_Cantidad, global::System.Nullable<double> Original_Precio) {
            return this.Update(Original_IdDetalles, idFactura, Producto, Descripcion, Cantidad, Precio, Original_IdDetalles, Original_idFactura, Original_Producto, Original_Descripcion, Original_Cantidad, Original_Precio);
        }
    }
    ...
    public partial class InformeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        cliente.*, detalleFactura.*, Factura.*
FROM            cliente INNER JOIN
                         Factura ON cliente.DNI = Factura.idCliente INNER JOIN
                         detalleFactura ON Factura.Identificador = detalleFactura.idFactura";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
